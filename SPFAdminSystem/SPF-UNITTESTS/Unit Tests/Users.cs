...
namespace SPF_UNITTESTS
{
    public class UsersTest : TestContext
    {
        ...
        public void GetUserByIdReturnsTheCorrectUser()
        {
            ...
            <h3 class=""align-middle"">Editing User:  {user2.FullName}</h3>
                    ...
                    <table class=""table table-striped table-hover border-info h-100"">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class=""align-middle"">{user2.UserName}</td>
                            ...
                            <tr>
                                ...
                                <td class=""align-middle"">{user2.FullName}</td>
                                <td class=""align-middle"" style=""width: 5%;"">
                                    <button style=""all: unset; cursor: pointer;"">
                                        <span class=""oi oi-pencil""></span>
                                    </button>
                            ...
                            <tr>
                                ...
                                <td class=""align-middle"">{user2.Role}</td>
                                <td class=""align-middle"" style=""width: 5%;"">
                                    <button style=""all: unset; cursor: pointer;"">
                                        <span class=""oi oi-pencil""></span>
                                    </button>
        ...
        public void ChangeFullNameUsesTheCorrectUser()
        {
            List<User> users = new();
            ...
            Assert.Equal(users[0], fullnamepopup.Instance.user);
        }
    }
}
